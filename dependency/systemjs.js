...
!function () {
    ...
    var p = "undefined" != typeof window && "undefined" != typeof document,
        ...
        w = "undefined" != typeof self ? self : global, t = "undefined" != typeof Symbol;
    ...
    if (y) {
        var n = (y = y.split("#")[0].split("?")[0]).lastIndexOf("/");
        -1 !== n && (y = y.substr(0, n + 1))
    } else {
    ...
    function b(e, t) {
        ...
        var r = t && t.substr(0, t.indexOf(":") + 1), n = e[0], o = e[1];
        ...
        if ("." === n && ("/" === o || "." === o && ("/" === e[2] || 2 === e.length && (e += "/")) || 1 === e.length && (e += "/")) || "/" === n) {
            ...
            for (var s = i.substr(0, i.lastIndexOf("/") + 1) + e, u = [], l = -1, c = 0; c < s.length; c++) if (-1 === l) if ("." !== s[c]) l = c; else {
    ...
    function s(r) {
        ...
        return e[Symbol.iterator] = function () {
            var e = Object.keys(r), t = 0;
            return {
                next: function () {
                    return t < e.length ? {value: r[e[t++]], done: !1} : {value: void 0, done: !0}
                }
            }
        }, e
    }
    ...
    var h = u.resolve = e("resolve"), m = u.resolveInstantiate = e("resolveInstantiate");
    ...
    var x = "undefined" != typeof Symbol && Symbol.iterator, E = e("registry");
    ...
    function j(e) {
        Object.defineProperty(this, S, {value: e}), Object.keys(e).forEach(P, this)
    }
    ...
    j.prototype = Object.create(null), k && Object.defineProperty(j.prototype, k, {value: "Module"});
    var _ = Promise.resolve(), R = e("register-internal");
    ...
    function M() {
        ...
        var n = {};
        this[R] = {lastRegister: void 0, records: n}, this.trace = !1
    }
    ...
    function U(e, t, r, n, o, i) {
        for (var a, s, u = 0; u < r.dependencies.length; u++) {
            var l;
            if (!((l = r.dependencyInstantiations[u]) instanceof j || "module" === l[k]) && (a = l.linkRecord)) if (l.evalError) q(t, l.evalError); else if (a.setters) {
                if (-1 === i.indexOf(l)) {
                    i.push(l);
                    try {
                        var c = U(e, l, a, n, o, i)
    ...
    function T(e, t, r, n, o, i) {
        ...
        var u, l, c, d, f, p, g,
            h = (u = e, l = t.key, c = r.dependencies, d = r.dependencyInstantiations, f = n, p = o, g = i, function (e) {
                for (var t = 0; t < c.length; t++) if (c[t] === e) {
                    var r, n = d[t];
                    if (n instanceof j || "module" === n[k]) r = n; else {
        ...
        if (!r.executingRequire) for (var m = 0; m < r.dependencies.length; m++) h(r.dependencies[m]);
        try {
        ...
        var y = s.default;
        if (y && y.__esModule) for (var b in y) Object.hasOwnProperty.call(y, b) && (s[b] = y[b]);
    ...
    M.prototype[M.resolve = u.resolve] = function (e, t) {
        return b(e, t || y)
    }, M.prototype[C] = function (e, t) {
    }, M.prototype[u.resolveInstantiate] = function (e, t) {
        var u = this, l = this[R], c = this.registry[E];
    ...
    var $ = new j({});
    var B, W = e("loader-config"), G = e("metadata"),
    ...
    function ie(e, t, r) {
        var n = se(t, r);
        if (n) {
            var o = t[n] + r.substr(n.length), i = b(o, y);
    ...
    var ue,
        le = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF."'])require\s*\(\s*("[^"\\]*(?:\\.[^"\\]*)*"|'[^'\\]*(?:\\.[^'\\]*)*'|`[^`\\]*(?:\\.[^`\\]*)*`)\s*\)/g;
    ...
    var fe = "undefined" != typeof XMLHttpRequest, pe = "undefined" != typeof fetch,
    ...
    function be(n, o, i, a, r, s) {
        ...
        return J.then(function () {
            if (r && r.packageConfig && "./" !== o.substr(0, 2)) {
                var e = r.packageConfig.map, t = e && se(e, o);
                if (t) return je(u, n, r.packageConfig, r.packageKey, t, o, a, s)
            }
            return J
        }).then(function (e) {
            if (e) return e;
            var t = ve.call(u, n, o, i, !0, !0), r = _e(n, t);
            return a.packageKey = r && r.packageKey || se(n.packages, t), a.packageKey ? -1 !== n.packageConfigKeys.indexOf(t) ? (a.packageKey = void 0, a.load = we(), a.load.format = "json", a.load.loader = "", Promise.resolve(t)) : (a.packageConfig = n.packages[a.packageKey] || (n.packages[a.packageKey] = qe()), (r && !a.packageConfig.configured ? function (e, t, r, n, o) {
                ...
                -1 === t.packageConfigKeys.indexOf(r) && t.packageConfigKeys.push(r);
    ...
    function je(t, r, e, n, o, i, a, s) {
        ...
        for (var d in u) {
            var f = Ce(d);
            c.push({condition: f, map: u[d]}), l.push(M.prototype.import.call(t, f.module, n))
        }
        return Promise.all(l).then(function (e) {
            for (var t = 0; t < c.length; t++) {
                var r = c[t].condition, n = oe(r.prop, "__useDefault" in e[t] ? e[t].__useDefault : e[t]);
    ...
    function _e(e, t) {
        for (var r, n, o, i, a, s = !1, u = 0; u < e.packageConfigPaths.length; u++) {
            var l = e.packageConfigPaths[u], c = Pe[l] || (Pe[l] = (void 0, i = (o = l).lastIndexOf("*"), {
    ...
    function Qe(e, t, r, n, o, i, a) {
        if (t) {
            ...
            try {
                He(e), !Je && e._nodeRequire && (Je = e._nodeRequire("vm"), Ne = Je.runInThisContext("typeof System !== 'undefined' && System") === e), Ne ? Je.runInThisContext(We(t, r, n, !a), {filename: n + (r ? "!transpiled" : "")}) : (0, eval)(We(t, r, n, !a)), Ze()
            } catch (e) {
                return Ze(), e
            }
        }
    ...
    function Ve(p) {
        function g(e, t, r, n) {
            ...
            if ("string" == typeof e && "function" == typeof t && (e = [e]), !(e instanceof Array)) {
                ...
                var o = p.decanonicalize(e, n), i = p.get(o);
    ...
    function rt(e) {
        ...
        return n.pop(), n = n.join("/"), {filename: et(t), dirname: et(n)}
    }
    ...
    var nt = /(^|[^\\])(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm,
        ot = /("[^"\\\n\r]*(\\.[^"\\\n\r]*)*"|'[^'\\\n\r]*(\\.[^'\\\n\r]*)*')/g;
    var it,
        at = ["_g", "sessionStorage", "localStorage", "clipboardData", "frames", "frameElement", "external", "mozAnimationStartTime", "mozPaintCount", "webkitStorageInfo", "webkitIndexedDB", "mozInnerScreenY", "mozInnerScreenX"];
    ...
    function lt(e, i, t, a) {
        var s, u = w.define;
        if (w.define = void 0, t) for (var r in s = {}, t) s[r] = w[r], w[r] = t[r];
        return i || (it = {}, Object.keys(w).forEach(st, function (e, t) {
            ...
            }), n = o ? n : r, s) for (var e in s) w[e] = s[e];
            return w.define = u, n
        }
    }

    var ct = "(?:^|[^$_a-zA-Z\\xA0-\\uFFFF.])", dt = "\\s*\\(\\s*(\"([^\"]+)\"|'([^']+)')\\s*\\)", ft = /\(([^\)]*)\)/,
        pt = /^\s+|\s+$/g, gt = {};

    function ht(n) {
        return function (e, t, r) {
            n(e, t, r), "object" != typeof(t = r.exports) && "function" != typeof t || "__esModule" in t || Object.defineProperty(r.exports, "__esModule", {value: !0})
        }
    }

    var mt, vt, yt = !1, bt = !1;
    var wt,
        kt = (p || H) && "undefined" != typeof navigator && navigator.userAgent && !navigator.userAgent.match(/MSIE (9|10).0/);
    ...
    function Et(p, g, e, h, m) {
        return Promise.resolve(e).then(function (e) {
            return "detect" === h.load.format && (h.load.format = void 0), function (e, t) {
                var r = e.match(Kt);
                if (!r) return;
            ...
            return h.pluginLoad.source = t, Promise.resolve(h.pluginModule.instantiate.call(p, h.pluginLoad, function (e) {
                ...
                return r ? t : function (e) {
                    ...
                    return new j({default: e, __useDefault: e})
                }(e)
            })
        }).then(function (c) {
            ...
            switch (h.load.format) {
                ...
                case"json":
                    var i = JSON.parse(c);
                    return p.newModule({default: i, __useDefault: i});
                case"amd":
                    var a = w.define;
                    ...
                    break;
                case"cjs":
                    var d = h.load.deps, u = (h.load.deps || []).concat(h.load.cjsRequireDetection ? function (e) {
                        ...
                        for (; t = le.exec(e);) if (!i(n, t) && !i(o, t)) {
                    ...
                    p.registerDynamic(u, !0, function (e, t, r) {
                        ...
                        }, r.paths = [], r.require = e, !h.load.cjsDeferDepsExecute && d) for (var n = 0; n < d.length; n++) e(d[n]);
                        var o = rt(r.id), i = {exports: t, args: [e, t, r, o.filename, o.dirname, w, w]},
                            a = "(function (require, exports, module, __filename, __dirname, global, GLOBAL";
                        if (h.load.globals) for (var s in h.load.globals) i.args.push(e(h.load.globals[s])), a += ", " + s;
                        var u = w.define;
                ...
                case"global":
                    ...
                    p.registerDynamic(u, !1, function (e, t, r) {
                        var n;
                        if (h.load.globals) for (var o in n = {}, h.load.globals) h.load.globals[o] && (n[o] = e(h.load.globals[o]));
    ...
    if ("undefined" != typeof document) {
        var Ft = document.getElementsByTagName("script"), qt = Ft[Ft.length - 1];
    ...
    function Ut() {
        ...
        M.call(this), this._loader = {}, this[G] = {}, this[W] = {
            ...
            getPathVars: rt
        })), e.set("@@global-helpers", e.newModule({prepareGlobal: lt})), Ve(this)
    }
    ...
    ((Ut.prototype = Object.create(M.prototype)).constructor = Ut).prototype[Ut.resolve = M.resolve] = Ut.prototype.normalize = function (r, n) {
        ...
        var n = this[W], o = {
            ...
            packageConfig: void 0,
            load: void 0
        }, i = i || he(0, n, r), a = ke(n.pluginFirst, t);
        ...
        return (function (e, t, r) {
            var n;
            if (p && (n = e.depCache[r])) for (var o = 0; o < n.length; o++) t.normalize(n[o], r).then(te); else {
                var i = !1;
            ...
            if (!c()) {
                ...
                return d.registerDynamic([], !1, function () {
                    return function (e, t) {
                        ...
                        if (!B) {
                            var r = this._nodeRequire("module"), n = decodeURI(t.substr(a ? 8 : 7));
        ...
        var r, n = this, o = this[W];
        if ("warnings" in e && (o.warnings = e.warnings), "wasm" in e && (o.wasm = "undefined" != typeof WebAssembly && e.wasm), ("production" in e || "build" in e) && Tt.call(n, !!e.production, !!(e.build || At && At.build)), !t) for (var i in De(0, e, function (e) {
            r = r || e.baseURL
        ...
        if (e.defaultJSExtensions && Z.call(o, "The defaultJSExtensions configuration option is deprecated.\n  Use packages defaultExtension instead.", !0), "boolean" == typeof e.pluginFirst && (o.pluginFirst = e.pluginFirst), e.map) for (var i in e.map) {
            var a = e.map[i];
            if ("string" == typeof a) {
        ...
        if (e.depCache) for (var i in e.depCache) o.depCache[n.normalizeSync(i)] = [].concat(e.depCache[i]);
        if (e.meta) for (var i in e.meta) if ("*" === i[0]) X(o.meta[i] = o.meta[i] || {}, e.meta[i]); else {
